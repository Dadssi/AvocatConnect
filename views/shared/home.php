                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Votre solution juridique,<br>à portée de <span class="span-clic">clic</span></h1>
                            <p class="paragraph-large text-white animated slideInLeft mb-4 pb-2">Trouvez l'avocat qu'il vous faut en quelques minutes. Simplifiez vos démarches, accédez à des experts spécialisés, et obtenez les conseils dont vous avez besoin pour avancer en toute sérénité</p>
                            <a href="" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Trouvez un Avocat</a>
                        </div>
        ...
        <div class="container-xxl py-5" id="blog">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Actualités juridiques</h1>
                </div>
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        <li class="nav-item">
                            ...
                            <i class="fa fa-gavel fa-2x text-primary"></i>
                                <div class="ps-3">
                                    <small class="text-body">Législation</small>
                                    <h6 class="mt-n1 mb-0">Marocaine</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <i class="fa fa-balance-scale fa-2x text-primary"></i>
                                <div class="ps-3">
                                    <small class="text-body">Derniers</small>
                                    <h6 class="mt-n1 mb-0">Décisions Judiciaires</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <i class="fa fa-file-alt fa-2x text-warning"></i>
                                <div class="ps-3">
                                    <small class="text-body">Réformes &</small>
                                    <h6 class="mt-n1 mb-0">Politiques Publiques</h6>
                                </div>
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-1.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Adoption de la nouvelle loi sur le travail à distance au Maroc</span>
                                                <span style="width: 50%;"class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic">La récente adoption de la loi sur le télétravail marque une avancée majeure dans l'adaptation des réglementations aux réalités modernes. Découvrez ses principaux points et implications.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-2.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Modifications du Code de la Famille : Ce qu’il faut savoir</span>
                                                <span style="width: 50%;" class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic">Le Code de la Famille marocain a subi des changements importants. Cet article explore les nouvelles dispositions qui concernent directement les citoyens.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-3.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Nouvelle loi sur la cybersécurité : Protéger les données personnelles</span>
                                                <span style="width: 50%;" class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic">Face à l’augmentation des cyberattaques, le Maroc met en œuvre une nouvelle loi pour renforcer la sécurité des données. Voici ce qu’elle implique.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-4.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Révision du Code Pénal : Nouvelles sanctions introduites</span>
                                                <span style="width: 50%;" class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic">Le projet de révision du Code Pénal introduit des sanctions adaptées aux défis actuels. Apprenez-en davantage sur ces changements.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-5.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Exonérations fiscales pour les startups marocaines en 2024</span>
                                                <span style="width: 50%;" class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic">Le gouvernement marocain encourage l’entrepreneuriat avec des exonérations fiscales. Découvrez les critères et les secteurs concernés.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-6.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span> Régulation des plateformes numériques : Les nouvelles règles en vigueur</span>
                                                <span style="width: 50%;" class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic"> Le Maroc adopte une législation pour encadrer les activités des plateformes numériques. Consultez cet article pour en savoir plus.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-7.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Décret sur les énergies renouvelables : Une étape vers la transition verte</span>
                                                <span style="width: 50%;" class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic">Le Maroc franchit une nouvelle étape dans sa transition énergétique avec un décret axé sur les énergies renouvelables. Découvrez les détails.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../assets/images/menu-8.jpg" alt="" style="width: 120px; height: 100%">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Nouvelles réglementations sur les contrats de location</span>
                                                <span style="width: 50%;" class="text-primary">Voir détails</span>
                                            </h5>
                                            <small class="fst-italic">Une mise à jour des réglementations sur les contrats de location entre en vigueur. Voici ce que les locataires et les propriétaires doivent savoir.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
